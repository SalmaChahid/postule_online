        ...
        <div class="flex h-screen">
            ...
            <main id="main-content" class="flex-1 ml-64 bg-white overflow-hidden my-6">
                <div class="w-[94%] m-auto rounded-sm bg-[#003366]">        
                    <h1 class="text-2xl font-semibold mb-1 text-white p-2">Les demandes refusées</h1>
                    <hr class="text-gray-200" >
                </div>
                 <!-- Add overflow-hidden here -->
                <div class="container mx-auto w-[94%] py-12">                    
                    <!-- User Table -->
                                            ...
                                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                                ...
                                                <td class="py-3 px-4 text-center whitespace-nowrap">
                                                    <div class="flex items-center justify-center space-x-2">
                                                        ...
                                                        @else
                                                        <button class="px-2 py-1 pointer-events-none opacity-50 cursor-not-allowed disabled bg-green-500 text-white rounded hover:bg-green-600 focus:outline-none btn-accepter" data-candidate-id="{{ $candidate->id }}">
                                                            Accepter
                                                        </button>
                                                        <button class="px-2 py-1 pointer-events-none opacity-50 cursor-not-allowed disabled bg-red-600 text-white rounded hover:bg-red-700 focus:outline-none btn-supprimer" data-candidate-id="{{ $candidate->id }}">
                                                            Supprimer
                                                        </button>
                                                        @endcan
                                                    </div>
